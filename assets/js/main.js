...
$(document).ready(function() {
    ...
    $(window).load(function() {
        $(".js-preloader").fadeOut(500, function() {
            $(".js-main-container").fadeIn(500);
...
function setup_nivo_lightbox()
{
    if($.isFunction($.fn.nivoLightbox))
    {
        ...
        $selector.nivoLightbox({
            ...
            errorMessage: 'Пока загрузка невозможно, попробуйте позже' // Error message when content can't be loaded
        });
...
function toggleTheme() { 
    ...
    if (theme.getAttribute('href') == 'assets/css/themes.dark.css') { 
        theme.setAttribute('href', 'assets/css/themes.light.css'); 
    } else { 
        theme.setAttribute('href', 'assets/css/themes.dark.css'); 
    } 
} 